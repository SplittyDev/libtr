...
namespace libtr.TR2
{
	...
	public struct RoomStaticMesh
	{
		...
		/// <summary>
		/// Like <see cref="Intensity1"/> and almost
		/// always the same value
		/// UInt16 in spec, changed to Int16
		/// </summary>
		[FieldOffset (16)]
		readonly public Int16 Intensity2;
		...
		/// <param name="intensity2">Intensity2.</param>
		/// <param name="objectid">Objectid.</param>
		public RoomStaticMesh (
			UInt32 x, UInt32 y, UInt32 z,
			UInt16 rotation, Int16 intensity1,
			Int16 intensity2, UInt16 objectid) : this () {
			X = x;
			Y = y;
			Z = z;
			Rotation = rotation;
